...
import 'package:newsapps/model/business/business.dart';
import 'package:newsapps/model/science/science.dart';
import 'package:newsapps/model/setting/setting.dart';
import 'package:newsapps/model/sport/sport.dart';
...
class NewsAppCubit extends Cubit<NewsAppStates>{
  ...
  void changeBottomNavBar({
    ...
    if(index == 1){
      NewsAppCubit.get(context).currentLanguage=='En'? getDataSport():getDataSportArbic();
    }
    if(index == 2){
      NewsAppCubit.get(context).currentLanguage=='En'? getDataScience():getDataScienceArbic();
